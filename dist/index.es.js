import rt, { useRef as Mt, useState as lt, useEffect as qt, createContext as Ue, useContext as De } from "react";
var Ot = { exports: {} }, yt = {};
/**
 * @license React
...
function Ve() {
  ...
  return yt.Fragment = i, yt.jsx = x, yt.jsxs = x, yt;
}
var Ct = {};
/**
 * @license React
...
function Qe() {
  return _t || (_t = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function ft(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === c || t === d || _ || t === h || t === w || t === R || gt || t === V || P || z || nt || typeof t == "object" && t !== null && (t.$$typeof === J || t.$$typeof === Q || t.$$typeof === x || t.$$typeof === u || t.$$typeof === f || // This needs to include all possible module reference object
    ...
    var ot = Object.assign, st = 0, l, o, s, g, a, I, C;
    function Z() {
    }
    ...
    function j() {
      {
        if (st === 0) {
          l = console.log, o = console.info, s = console.warn, g = console.error, a = console.group, I = console.groupCollapsed, C = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: Z,
...
` + M[v].replace(" at new ", " at ");
        ...
        S = !1, m.current = U, q(), Error.prepareStackTrace = B;
      }
    ...
    function pe(t, n) {
      if (typeof t.ref == "string" && xt.current && n && xt.current.stateNode !== n) {
        var A = $(xt.current.type);
        Ft[A] || (O('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', $(xt.current.type), t.ref), Ft[A] = !0);
      }
    }
    function Ee(t, n) {
      {
    ...
    function Ce(t, n, A, p, B) {
      {
        ...
        return ye(t, M, b, B, p, xt.current, k);
      }
    }
...
Check the top-level render call using <` + A + ">.");
    ...
    var Ie = Re, Fe = Te;
    Ct.Fragment = c, Ct.jsx = Ie, Ct.jsxs = Fe;
  }()), Ct;
}
process.env.NODE_ENV === "production" ? Ot.exports = Ve() : Ot.exports = Qe();
var T = Ot.exports;
const je = "_button_cey8f_1", qe = "_primary_cey8f_11", Oe = "_accent_cey8f_23", ve = "_secondary_cey8f_36", He = "_surfaceSecondary_cey8f_48", $t = {
  button: je,
  primary: qe,
  accent: Oe,
  secondary: ve,
...
function Ye({ date: e, onChange: r }) {
  const i = Mt(r), c = Mt(e), h = Mt(null), d = Mt(null), [x, u] = lt(Et), [f, w] = lt(Et), [R, Q] = lt(!1), [J, V] = lt(!1), E = () => Q(!1), K = () => V(!1), tt = (D) => {
    u((P) => {
      var nt, gt, _;
      if (!R)
  ...
  return qt(() => {
    ...
    if (!c.current)
      return;
    const D = parseInt(x, 10), P = parseInt(f, 10);
    if (isNaN(D) || isNaN(P))
      return;
...
function be({ month: e, year: r }) {
  ...
  let x;
  h.getDay() === 0 ? x = new Date(h) : (x = new Date(h), x.setDate(x.getDate() + (7 - x.getDay())));
  for (let u = new Date(d); u <= x; u.setDate(u.getDate() + 1))
    i.push({
      isInMonth: u >= c && u <= h,
      date: new Date(u)
    });
...
const ze = "_calendar_11xd8_1", Ne = "_monthAndYear_11xd8_8", We = "_arrowContainer_11xd8_16", Ge = "_arrow_11xd8_16", Xe = "_back_11xd8_36", _e = "_forward_11xd8_40", $e = "_dayName_11xd8_44", tr = "_dates_11xd8_53", er = "_date_11xd8_53", rr = "_dateNumber_11xd8_65", nr = "_today_11xd8_80", or = "_disabled_11xd8_84", ar = "_selected_11xd8_90", ir = "_inRange_11xd8_99", Ar = "_startDate_11xd8_106", cr = "_endDate_11xd8_112", sr = "_firstDayOfMonth_11xd8_118", lr = "_firstDayOfWeek_11xd8_118", ur = "_lastDayOfMonth_11xd8_123", gr = "_lastDayOfWeek_11xd8_123", fr = "_hidden_11xd8_129", hr = "_dateTimeDivider_11xd8_134", F = {
  calendar: ze,
  monthAndYear: Ne,
  arrowContainer: We,
  arrow: Ge,
...
function Br({ isInMonth: e, date: r, selectedDate: i, disableBefore: c, disableAfter: h }) {
  const d = kt(r, /* @__PURE__ */ new Date()), x = i ? kt(r, i) : !1, u = (c ? oe(r, c) : !1) || (h ? ae(r, h) : !1);
  return ut({
    [F.dateNumber]: !0,
    [F.disabled]: u,
    [F.hidden]: !e,
...
function Tr({
  ...
  const c = r == null ? void 0 : r[0], h = r == null ? void 0 : r[1], d = r ? Mr(e, r) : !1, x = c ? kt(e, c) : !1, u = h ? kt(e, h) : !1;
  return ut({
    [F.inRange]: d,
    [F.startDate]: x,
    [F.endDate]: u,
...
function Fr({ initialDate: e }) {
  const [r, i] = lt(yr(e)), [c, h] = lt(Cr(e)), d = (f) => {
    h((w) => {
      const R = w + f;
...
function Dr(e) {
  var r = function(i) {
    var c = e.attr, h = e.size, d = e.title, x = Ur(e, ["attr", "size", "title"]), u = h || i.size || "1em", f;
...
function Vr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M12 5v14" } }, { tag: "path", attr: { d: "m19 12-7 7-7-7" } }] })(e);
}
function Qr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "m12 19-7-7 7-7" } }, { tag: "path", attr: { d: "M19 12H5" } }] })(e);
}
function jr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M5 12h14" } }, { tag: "path", attr: { d: "m12 5 7 7-7 7" } }] })(e);
}
function qr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "m5 12 7-7 7 7" } }, { tag: "path", attr: { d: "M12 19V5" } }] })(e);
}
function Or(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9" } }, { tag: "path", attr: { d: "M10.3 21a1.94 1.94 0 0 0 3.4 0" } }] })(e);
}
function vr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "rect", attr: { width: "18", height: "18", x: "3", y: "4", rx: "2", ry: "2" } }, { tag: "line", attr: { x1: "16", x2: "16", y1: "2", y2: "6" } }, { tag: "line", attr: { x1: "8", x2: "8", y1: "2", y2: "6" } }, { tag: "line", attr: { x1: "3", x2: "21", y1: "10", y2: "10" } }] })(e);
}
function Hr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "polyline", attr: { points: "20 6 9 17 4 12" } }] })(e);
}
function Kr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "m6 9 6 6 6-6" } }] })(e);
}
function Pr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "m15 18-6-6 6-6" } }] })(e);
}
function Yr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "m9 18 6-6-6-6" } }] })(e);
}
function Zr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "m18 15-6-6-6 6" } }] })(e);
}
function Jr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "circle", attr: { cx: "12", cy: "12", r: "10" } }, { tag: "polyline", attr: { points: "12 6 12 12 16 14" } }] })(e);
}
function Sr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "rect", attr: { width: "14", height: "14", x: "8", y: "8", rx: "2", ry: "2" } }, { tag: "path", attr: { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" } }] })(e);
}
function Lr(e) {
...
function br(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "polygon", attr: { points: "22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" } }] })(e);
}
function zr(e) {
...
function Wr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M2 18v3c0 .6.4 1 1 1h4v-3h3v-3h2l1.4-1.4a6.5 6.5 0 1 0-4-4Z" } }, { tag: "circle", attr: { cx: "16.5", cy: "7.5", r: ".5" } }] })(e);
}
function Gr(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "rect", attr: { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2" } }, { tag: "path", attr: { d: "M7 11V7a5 5 0 0 1 10 0v4" } }] })(e);
}
function Xr(e) {
...
function _r(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M5 12h14" } }, { tag: "path", attr: { d: "M12 5v14" } }] })(e);
}
function $r(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "circle", attr: { cx: "11", cy: "11", r: "8" } }, { tag: "path", attr: { d: "m21 21-4.3-4.3" } }] })(e);
}
function tn(e) {
...
function en(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "polygon", attr: { points: "12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" } }] })(e);
}
function rn(e) {
...
function An(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "rect", attr: { width: "18", height: "11", x: "3", y: "11", rx: "2", ry: "2" } }, { tag: "path", attr: { d: "M7 11V7a5 5 0 0 1 9.9-1" } }] })(e);
}
function cn(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" } }, { tag: "circle", attr: { cx: "9", cy: "7", r: "4" } }, { tag: "line", attr: { x1: "22", x2: "16", y1: "11", y2: "11" } }] })(e);
}
function sn(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" } }, { tag: "circle", attr: { cx: "9", cy: "7", r: "4" } }, { tag: "line", attr: { x1: "19", x2: "19", y1: "8", y2: "14" } }, { tag: "line", attr: { x1: "22", x2: "16", y1: "11", y2: "11" } }] })(e);
}
function ln(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" } }, { tag: "circle", attr: { cx: "12", cy: "7", r: "4" } }] })(e);
}
function un(e) {
...
function gn(e) {
  return y({ tag: "svg", attr: { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, child: [{ tag: "path", attr: { d: "M18 6 6 18" } }, { tag: "path", attr: { d: "m6 6 12 12" } }] })(e);
}
function fn(e) {
...
function vt({
  ...
  const { incrementMonth: u, decrementMonth: f, shownMonth: w, shownYear: R } = Fr({ initialDate: e }), Q = be({ month: w, year: R }), J = (E) => {
    ...
    if (e && kt(E, e))
      return c(null);
    !d && x ? K.setHours(23, 59, 59) : e && K.setHours(e.getHours(), e.getMinutes()), c(K);
  }, V = (E) => {
    c(E);
  };
...
const xn = "_dateRangePicker_1cn8q_1", yn = "_virticalRule_1cn8q_11", re = {
  dateRangePicker: xn,
  virticalRule: yn
};
function Rn({ date1: e, date2: r, disableBefore: i, disableAfter: c, onDate1Change: h, onDate2Change: d, includeTime: x }) {
...
(function(e, r) {
  (function(i, c) {
    ...
    var x = {};
    return (() => {
      d.r(x), d.d(x, { Actions: () => V, default: () => st, isAbortError: () => tt, isErrorResponse: () => K, useDelete: () => z, useGet: () => gt, useGetImmediate: () => wt, usePost: () => Rt, usePut: () => $, useUpload: () => ot });
      var u = function() {
        ...
        return new (s || (s = Promise))(function(a, I) {
          ...
          function j(q) {
            var m;
            q.done ? a(q.value) : (m = q.value, m instanceof s ? m : new s(function(N) {
              N(m);
            })).then(C, Z);
          }
          j((g = g.apply(l, o || [])).next());
        });
      }, w = function(l, o) {
        var s, g, a, I, C = { label: 0, sent: function() {
          if (1 & a[0])
            throw a[1];
          return a[1];
        }, trys: [], ops: [] };
                ...
                try {
                  ...
                  switch (g = 0, a && (m = [2 & m[0], a.value]), m[0]) {
                    ...
                    case 7:
                      ...
                      continue;
                    default:
                      if (!((a = (a = C.trys).length > 0 && a[a.length - 1]) || m[0] !== 6 && m[0] !== 2)) {
                        C = 0;
                        continue;
                      }
                      ...
                      if (m[0] === 6 && C.label < a[1]) {
                        C.label = a[1], a = m;
                        break;
                      }
                      if (a && C.label < a[2]) {
                        C.label = a[2], C.ops.push(m);
                        break;
                      }
      ...
      function J(l, o) {
        return o === void 0 && (o = {}), f(this, void 0, void 0, function() {
          var s, g, a, I, C, Z, j, q, m, N, W;
          return w(this, function(S) {
            switch (S.label) {
              case 0:
                return s = o.method, g = s === void 0 ? "GET" : s, a = o.headers, I = a === void 0 ? {} : a, C = o.params, Z = C === void 0 ? {} : C, j = o.body, q = o.signal, m = function(L) {
                ...
                }(Z || {}), N = "".concat(l, "?").concat(m), W = j instanceof FormData, [4, fetch(N, u({ method: g, signal: q, credentials: "include", headers: u(u({}, R(W)), I) }, j && { body: W ? j : JSON.stringify(j) }))];
              case 1:
                return [4, Q(S.sent())];
              case 2:
                return [2, S.sent()];
      ...
      function D(l, o) {
        o === void 0 && (o = {});
        var s = (0, E.useReducer)(O, o != null && o.immediate ? { status: "loading" } : { status: "initial" }), g = s[0], a = s[1], I = (0, E.useRef)(l), C = (0, E.useRef)(o);
        (0, E.useEffect)(function() {
          I.current = l, C.current = o;
        }, [l, o]);
        var Z = (0, E.useCallback)(function(q) {
          q === void 0 && (q = {});
          var m = new AbortController(), N = Y(Y({}, q), { signal: m.signal });
        ...
        (0, E.useEffect)(function() {
          C.current.immediate && Z(C.current.fetchOptions);
        }, [Z]);
        var j = (0, E.useCallback)(function() {
          a({ type: V.RESET_STATE });
        }, []);
        return [Z, { state: g, actions: { resetState: j } }];
      }
      var P = function() {
      ...
      function wt(l, o) {
        var s = D(l, _(_({}, o), { immediate: !0 })), g = s[0], a = s[1], I = a.state, C = a.actions;
        return { state: I, actions: _(_({}, C), { refetch: g }) };
      }
      var ft = function() {
      ...
      function ot(l, o) {
        o === void 0 && (o = {});
        var s = D(l, o), g = s[0], a = s[1], I = a.state, C = a.actions;
        return [(0, E.useCallback)(function(Z, j) {
          var q = new FormData();
          return q.append("blob", Z), j != null && j.body && q.append("body", JSON.stringify(j.body)), g({ method: "POST", signal: j == null ? void 0 : j.signal, params: j == null ? void 0 : j.params, body: q });
        }, [g]), { state: I, actions: C }];
      }
      const st = J;
    })(), x;
...
const se = Ue({
  ...
  const { cache: r, serverUrl: i } = De(se), [c, h] = lt(e.src ?? null), [d, { state: x }] = Cn.useGet(`${i}/image`, {
    onComplete: (f) => {
  ...
  }, [e.imageId, r, d]), x.status === "loading" || c === null)
    return /* @__PURE__ */ T.jsx("div", { className: `${jt.image} ${e.className} loading-placeholder` });
  if (x.status === "error")
    return /* @__PURE__ */ T.jsx("img", { src: ne, alt: "error", className: `${jt.image} ${e.className} error-placeholder` });
  const u = (f) => {
    f.currentTarget.src = ne, f.currentTarget.style.objectFit = "cover", f.currentTarget.classList.add("error-placeholder");
  };
  return /* @__PURE__ */ T.jsx("img", { src: c, alt: e.alt, className: `${jt.image} ${e.className}`, onError: u });
};
export {
  wn as Button,
  Tn as DatePicker,
