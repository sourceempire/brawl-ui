...
function Re() {
  return Vt || (Vt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Qt(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === i || t === f || tt || t === u || t === w || t === m || Q || t === P || O || N || X || typeof t == "object" && t !== null && (t.$$typeof === j || t.$$typeof === C || t.$$typeof === p || t.$$typeof === d || t.$$typeof === h || // This needs to include all possible module reference object
    ...
    var Y = Object.assign, K = 0, _t, xt, wt, Ct, bt, Lt, Dt;
    function Rt() {
    }
    ...
    function ee() {
      {
        if (K === 0) {
          _t = console.log, xt = console.info, wt = console.warn, Ct = console.error, bt = console.group, Lt = console.groupCollapsed, Dt = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: Rt,
...
function Ne({ date: e, onChange: n }) {
  const o = it(n), i = it(e), u = it(null), f = it(null), [p, d] = U($), [h, w] = U($), [m, C] = U(!1), [j, P] = U(!1), x = () => C(!1), E = () => P(!1), I = (R) => {
    d((O) => {
      var X, Q, tt;
      if (!m)
...
const Ye = "_calendar_11xd8_1", He = "_monthAndYear_11xd8_8", ze = "_arrowContainer_11xd8_16", Ve = "_arrow_11xd8_16", $e = "_back_11xd8_36", Ue = "_forward_11xd8_40", Ke = "_dayName_11xd8_44", Ge = "_dates_11xd8_53", Je = "_date_11xd8_53", qe = "_dateNumber_11xd8_65", Ze = "_today_11xd8_80", Xe = "_disabled_11xd8_84", Qe = "_selected_11xd8_90", tr = "_inRange_11xd8_99", er = "_startDate_11xd8_106", rr = "_endDate_11xd8_112", nr = "_firstDayOfMonth_11xd8_118", ar = "_firstDayOfWeek_11xd8_118", or = "_lastDayOfMonth_11xd8_123", ir = "_lastDayOfWeek_11xd8_123", sr = "_hidden_11xd8_129", ur = "_dateTimeDivider_11xd8_134", y = {
  calendar: Ye,
  monthAndYear: He,
  arrowContainer: ze,
  arrow: Ve,
