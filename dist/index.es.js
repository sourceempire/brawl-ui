import B, { useRef as ot, useState as U, useEffect as Ht } from "react";
var pt = { exports: {} }, J = {};
/**
 * @license React
...
function Le() {
  ...
  function p(d, h, w) {
    ...
    w !== void 0 && (j = "" + w), h.key !== void 0 && (j = "" + h.key), h.ref !== void 0 && (P = h.ref);
    for (m in h)
...
function Re() {
  return Vt || (Vt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var O = !1, N = !1, Z = !1, X = !1, Q = !1, mt;
    mt = Symbol.for("react.module.reference");
    function Qt(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === i || t === f || Q || t === u || t === w || t === m || X || t === P || O || N || Z || typeof t == "object" && t !== null && (t.$$typeof === j || t.$$typeof === C || t.$$typeof === p || t.$$typeof === d || t.$$typeof === h || // This needs to include all possible module reference object
    ...
    var Y = Object.assign, K = 0, _t, xt, wt, Ct, bt, Dt, Lt;
    function Rt() {
    }
    ...
    function ee() {
      {
        if (K === 0) {
          _t = console.log, xt = console.info, wt = console.warn, Ct = console.error, bt = console.group, Dt = console.groupCollapsed, Lt = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: Rt,
...
`), M = s.stack.split(`
`), b = l.length - 1, D = M.length - 1; b >= 1 && D >= 0 && l[b] !== M[D]; )
            D--;
          for (; b >= 1 && D >= 0; b--, D--)
            if (l[b] !== M[D]) {
              if (b !== 1 || D !== 1)
...
` + l[b].replace(" at new ", " at ");
                    return t.displayName && S.includes("<anonymous>") && (S = S.replace("<anonymous>", t.displayName)), typeof t == "function" && et.set(t, S), S;
                  }
                while (b >= 1 && D >= 0);
              break;
            }
      ...
      var V = t ? t.displayName || t.name : "", Yt = V ? tt(V) : "";
      return typeof t == "function" && et.set(t, Yt), Yt;
    }
    function ae(t, r, a) {
      return Et(t, !1);
    }
    ...
    var nt = Object.prototype.hasOwnProperty, Mt = {}, jt = T.ReactDebugCurrentFrame;
    function at(t) {
      if (t) {
        var r = t._owner, a = rt(t.type, t._source, r ? r.type : null);
    ...
    function ie(t, r, a, s, v) {
      {
        ...
        for (var g in t)
          if (k(t, g)) {
            ...
            l && !(l instanceof Error) && (at(v), L("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", s || "React class", a, g, typeof l), at(null)), l instanceof Error && !(l.message in Mt) && (Mt[l.message] = !0, at(v), L("Failed %s type: %s", a, l.message), at(null));
          }
      }
    }
    ...
    function Tt(t) {
      if (ce(t))
        return L("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", ue(t)), Ot(t);
    }
    ...
    function he(t, r) {
      if (typeof t.ref == "string" && G.current && r && G.current.stateNode !== r) {
        ...
        ft[a] || (L('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', F(G.current.type), t.ref), ft[a] = !0);
      }
    }
    function ge(t, r) {
      {
        var a = function() {
          St || (St = !0, L("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function ve(t, r) {
      {
        var a = function() {
          Pt || (Pt = !0, L("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r));
        };
    ...
    function ye(t, r, a, s, v) {
      {
        ...
        for (k in r)
          nt.call(r, k) && !le.hasOwnProperty(k) && (g[k] = r[k]);
        if (t && t.defaultProps) {
...
Check the top-level render call using <` + a + ">.");
    ...
    function Bt(t, r) {
      {
        ...
        Wt[a] = !0;
        var s = "";
        t && t._owner && t._owner !== dt.current && (s = " It was passed a child from " + F(t._owner.type) + "."), z(t), L('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, s), z(null);
      }
    }
    function At(t, r) {
      {
    ...
    function xe(t) {
      {
        for (var r = Object.keys(t.props), a = 0; a < r.length; a++) {
          var s = r[a];
          if (s !== "children" && s !== "key") {
            z(t), L("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", s), z(null);
            break;
          }
        }
        t.ref !== null && (z(t), L("Invalid attribute `ref` supplied to `React.Fragment`."), z(null));
      }
    }
    function It(t, r, a, s, v, k) {
      {
        ...
        if (!g) {
          ...
          M ? l += M : l += Ft();
          var b;
          t === null ? b = "null" : lt(t) ? b = "array" : t !== void 0 && t.$$typeof === n ? (b = "<" + (F(t.type) || "Unknown") + " />", l = " Did you accidentally export a JSX literal instead of a component?") : b = typeof t, L("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", b, l);
        }
        var D = ye(t, r, a, v, k);
        if (D == null)
          return D;
    ...
    var be = Ce, De = we;
    q.Fragment = i, q.jsx = be, q.jsxs = De;
  }()), q;
}
process.env.NODE_ENV === "production" ? pt.exports = Le() : pt.exports = Re();
var _ = pt.exports;
...
function Ne({ date: e, onChange: n }) {
  const o = ot(n), i = ot(e), u = ot(null), f = ot(null), [p, d] = U($), [h, w] = U($), [m, C] = U(!1), [j, P] = U(!1), x = () => C(!1), E = () => P(!1), I = (R) => {
    d((O) => {
      var Z, X, Q;
      if (!m)
        return C(!0), R > 2 && ((Z = f.current) == null || Z.focus()), "0" + R;
      const N = parseInt(O[1], 10);
      return N < 2 || N === 2 && R < 4 ? ((X = f.current) == null || X.focus(), O[1] + R.toString()) : ((Q = f.current) == null || Q.focus(), "23");
    });
  }, T = (R) => {
    w((O) => {
      if (!j)
  ...
  return Ht(() => {
    ...
    resetTime: (R = {}) => {
      if (!e)
        return;
      const O = new Date(e);
      O.setHours(0), O.setMinutes(0), n(O), R.emptyField === "hour" ? d($) : (R.emptyField === "minute" || d($), w($));
    },
    onHourFocus: x,
    onMinuteFocus: E,
    handleHourChange: I,
...
function Ae({ date: e, onChange: n }) {
  ...
  } = Ne({ onChange: n, date: e }), C = ({ event: x, handleChange: E, focusRef: I, emptyField: T }) => {
    var L;
    switch (x.key) {
      case Fe:
      case We:
      ...
      case Be:
        ...
        break;
      default: {
        const R = parseInt(x.key, 10);
        isNaN(R) || E(R);
      }
    }
  }, j = (x) => C({ event: x, handleChange: w, focusRef: h, emptyField: "hour" }), P = (x) => C({ event: x, handleChange: m, focusRef: d, emptyField: "minute" });
...
const Ye = "_calendar_b0ead_1", He = "_monthAndYear_b0ead_8", ze = "_arrowContainer_b0ead_16", Ve = "_arrow_b0ead_16", $e = "_back_b0ead_36", Ue = "_forward_b0ead_40", Ke = "_dayName_b0ead_44", Ge = "_dates_b0ead_53", Je = "_date_b0ead_53", qe = "_dateNumber_b0ead_65", Ze = "_today_b0ead_80", Xe = "_disabled_b0ead_84", Qe = "_selected_b0ead_90", tr = "_inRange_b0ead_100", er = "_startDate_b0ead_107", rr = "_endDate_b0ead_113", nr = "_firstDayOfMonth_b0ead_119", ar = "_firstDayOfWeek_b0ead_119", or = "_lastDayOfMonth_b0ead_124", ir = "_lastDayOfWeek_b0ead_124", sr = "_hidden_b0ead_130", ur = "_dateTimeDivider_b0ead_135", y = {
  calendar: Ye,
  monthAndYear: He,
  arrowContainer: ze,
  arrow: Ve,
...
function kr({ isInMonth: e, date: n, selectedDate: o, disableBefore: i, disableAfter: u }) {
  const f = it(n, /* @__PURE__ */ new Date()), p = o ? it(n, o) : !1, d = (i ? Jt(n, i) : !1) || (u ? qt(n, u) : !1);
  return H({
    [y.dateNumber]: !0,
    [y.disabled]: d,
    [y.hidden]: !e,
...
function _r({
  ...
  const i = n == null ? void 0 : n[0], u = n == null ? void 0 : n[1], f = n ? pr(e, n) : !1, p = i ? it(e, i) : !1, d = u ? it(e, u) : !1;
  return H({
    [y.inRange]: f,
    [y.startDate]: p,
    [y.endDate]: d,
...
function yt({
  ...
  const { incrementMonth: d, decrementMonth: h, shownMonth: w, shownYear: m } = Cr({ initialDate: e }), C = Ie({ month: w, year: m }), j = (x) => {
    const E = new Date(x);
  ...
  return /* @__PURE__ */ _.jsxs("div", { className: y.calendar, children: [
    /* @__PURE__ */ _.jsxs("div", { children: [
      /* @__PURE__ */ _.jsxs("div", { className: y.monthAndYear, children: [
        /* @__PURE__ */ _.jsx("div", { className: xr({ shownMonth: w, shownYear: m, disableBefore: n }), onClick: h, children: /* @__PURE__ */ _.jsx(Kt.ChevronLeft, { className: H({ [y.arrow]: !0, [y.back]: !0 }) }) }),
        /* @__PURE__ */ _.jsxs("div", { children: [
          lr[w],
          " ",
          m
        ] }),
        /* @__PURE__ */ _.jsx("div", { className: wr({ shownMonth: w, shownYear: m, disableAfter: o }), onClick: d, children: /* @__PURE__ */ _.jsx(Kt.ChevronRight, { className: H({ [y.arrow]: !0, [y.forward]: !0 }) }) })
      ] }),
      /* @__PURE__ */ _.jsx("div", { className: y.dates, children: Array.from({ length: 7 }).map((x, E) => /* @__PURE__ */ _.jsx("div", { className: y.dayName, children: cr[E] }, E)) }),
      /* @__PURE__ */ _.jsx("div", { className: y.dates, children: C.map(({ date: x, isInMonth: E }) => {
        const I = kr({
          isInMonth: E,
          date: x,
          selectedDate: e,
          disableBefore: n,
          disableAfter: o
        }), T = _r({ date: x, dateRange: u, isInMonth: E, shownMonth: w, shownYear: m });
        return /* @__PURE__ */ _.jsxs("div", { className: y.date, children: [
          u && /* @__PURE__ */ _.jsx("div", { className: T }),
          /* @__PURE__ */ _.jsx("div", { className: I, onClick: () => j(x), children: x.getDate() })
        ] }, hr(x));
      }) })
    ] }),
    f && /* @__PURE__ */ _.jsxs("div", { children: [
      /* @__PURE__ */ _.jsx("div", { className: y.dateTimeDivider }),
      /* @__PURE__ */ _.jsx(Ae, { date: e, onChange: (x) => P(x) })
    ] })
  ] });
}
